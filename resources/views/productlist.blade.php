...
<!DOCTYPE html>
    <html>
        ...
        <body x-data="{openMenu : false}" id="backgrounf">
...
<h1 class="text-xl font-semibold mt-4 mb-4 text-center">Products List</h1>
...
<button class="font-[dm-sans] ml-6 mt-4 mb-4 bg-indigo-300 px-10 py-2 rounded-3xl hover:bg-indigo-600 hover:text-white transition delay-150 ease-in-out"><a href="{{URL('create-product')}}"> Create product</a> </button>
<button class= "font-[dm-sans] ml-6 mt-4 mb-4 bg-indigo-300 px-10 py-2 rounded-3xl hover:bg-indigo-600 hover:text-white transition delay-150 ease-in-out"><a href="{{URL('back')}}"> Back </a></button>
</div>
        ...
        <table class="min-w-full">
          ...
          @foreach ($data as $product)
            <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
              ...
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{$product ->author}} </td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{$product ->description}}</td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{$product ->category}}</td>   
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{$product ->price}}</td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{$product ->quantity}}</td>   
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"><img src="{{asset('./storage/images/'.$product->image)}}" width="100px" height="100px" alt="image"></td>  
              <td  class="p-3 border-2"><a href="{{URL('edit-product/'.$product->id)}}"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
</svg></a> </td>
 <td  class="p-3 border-2"><a href="{{URL('delete-product/'.$product->id)}}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
